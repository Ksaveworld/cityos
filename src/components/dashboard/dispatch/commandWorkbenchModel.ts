...
// 路线 B/C 在前两个线段完全重合。旧任务签收替换时按实际已行驶距离换算
// 归一化进度，避免车辆在共同路段上因为两条路线总长度不同而瞬移。
const TRAFFIC_SAFE_DECISION_PROGRESS_B = 0.3113963751
const TRAFFIC_SAFE_DECISION_PROGRESS_C = 0.2596594006
const TRAFFIC_ROUTE_B_TO_C_PROGRESS_RATIO = 0.8338549239
